<template>
	<div class="editHomeDesign">
		<el-breadcrumb separator-class="el-icon-arrow-right">
		  ...
		  <el-breadcrumb-item class="fontWeight">添加方案</el-breadcrumb-item>
		</el-breadcrumb>
		<div class="clear"></div>
...
export default {
	...
	data(){
		return{
			designUrl:'https://www.kujiale.com/v/auth?accesstoken='+this.$store.state.accessToken+'&dest=1'+'&designid='+this.$route.params.code
		}
	},
	//挂载
	mounted(){
